        ...
        @foreach ($daftar_uh as $df)
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-teal">
                    ...
                    <a href="/data_uh/{{ $df->ID_UH }}" class="small-box-footer">Info Lebih Lanjut <i
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="" value="new" class="EditBtn btn-sm btn-primary" data-toggle="modal"
                            data-target="#CreateModal" data-placement="top" title="Tambah Data">
                                            ...
                                            @foreach ($data as $fld)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="" value="{{ $fld->ID }}"
                                                            class="EditBtn btn-primary btn-xs" data-toggle="modal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="callout callout-info">
                            <dl class="row">
                                ...
                                <dd class="col-sx-1">:</dd>
                                <dd class="col-sm-7" id="aCPL"></dd>
                                <dt class="col-sm-4">Uraian</dt>
                                <dd class="col-sx-1">:</dd>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-info" data-dismiss="modal"><i class="fa fa-reply-all"></i>
                            Close</button>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="nilai" id="eNilai" class="form-control"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="DelRecForm">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                                    class="fa fa-reply-all"></i> Cancel</button>
                        ...
                        if ($i == 0) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    toastr.success(
                                        'SUCCESS.., Input data berhasil, Silahkan klik reload/refresh.'
                                        );
                                    location.reload();
                                },
                ...
                $('#DelRecForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            toastr.success(
                                'SUCCESS..., Data CPL sudah terhapus, Silahkan klik refresh/reload'
                                );
                            // location.reload();
                        },
                        error: function(error) {
